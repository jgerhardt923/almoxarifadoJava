...
public class Almoxarifado{
    ...
    private static void printMenuOptions() {
        ...
        /*if (usuarioLogado.get("adm").equals(Integer.parseInt("1"))){
        ...
        //if (usuarioLogado.get("adm").equals(Integer.parseInt("1"))) console.printf("        |__  excluir____________[24]\n\n");
        ...
        //if (usuarioLogado.get("adm").equals(Integer.parseInt("1"))) console.printf("        |__  excluir____________[34]\n\n");
        console.printf("    Movimentacoes\n");
        console.printf("        |__  Entradas\n");
        console.printf("        |       |__  novo_______[41]\n");
        console.printf("        |       |__  listar_____[42]\n");
        //if (usuarioLogado.get("adm").equals(Integer.parseInt("1"))) console.printf("        |       |__  excluir____[43]\n\n");
        console.printf("        |__  Saidas\n");
        console.printf("        |       |__  novo_______[51]\n");
        console.printf("        |       |__  listar_____[52]\n");
        //if (usuarioLogado.get("adm").equals(Integer.parseInt("1"))) console.printf("        |       |__  excluir____[53]\n\n\n");
    ...
    private static boolean processOption(String option) {
        /*if (option.equals("11") & usuarioLogado.get("adm").equals(Integer.parseInt("1"))) {
            usuarioView.create();
            return true;
        } else if (option.equals("12") & usuarioLogado.get("adm").equals(Integer.parseInt("1"))) {
            usuarioView.list();
            return true;
        } else if (option.equals("13") & usuarioLogado.get("adm").equals(Integer.parseInt("1"))) {
            usuarioView.update();
            return true;
        } else if (option.equals("14") & usuarioLogado.get("adm").equals(Integer.parseInt("1"))) {
            usuarioView.delete();
            return true;
            ...
            return true;
        }/* else if (option.equals("24") & usuarioLogado.get("adm").equals(Integer.parseInt("1"))) {
            ...
            objetoView.update();
            return true;
        }/* else if (option.equals("34") & usuarioLogado.get("adm").equals(Integer.parseInt("1"))) {
            objetoView.delete();
            return true;
            ...
            return true;
        }/* else if (option.equals("43") & usuarioLogado.get("adm").equals(Integer.parseInt("1"))) {
            return true;
        }*/ else if (option.equals("51")) {
            return true;
        } else if (option.equals("52")) {
            return true;
        }/* else if (option.equals("53") & usuarioLogado.get("adm").equals(Integer.parseInt("1"))) {
            return true;
